<div class="main-content-container container-fluid px-4 ml-4">
	<div class="page-header row no-gutters py-4 mb-3 border-bottom">
		<div class="col-12 col-sm-4 text-center text-sm-left mb-0">
		  ...
		  <h3 class="page-title">Reasignar Documentos</h3>
		</div>
	</div>
	<div class="row mb-2 mt-5 w-100">	
		<div class="col-sm-12">
			<button type="button" class="btn btn-lg btn-primary" style="position: fixed; bottom: 30px; right: 50px;z-index: 1;" id="arrFacturasASG">Reasignar a Funcionarios</button>			
		</div>	
